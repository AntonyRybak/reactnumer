...
import globalArhetype from '../function/GlobalArhetype'
import background from '../images/background.png';


export default function ArhetypeScreen() {

  let text = '';
  if (globalArhetype.arhetip === 1) {
  ...
  } else if (globalArhetype.arhetip === 2) {
    text = 'Вы тактичны, дипломатичны и любите работать в команде. Сильные стороны - умение слушать, быть гибким и способность к поддержке других. Хорошо подходят профессии, связанные с музыкой, искусством и дизайном.';
  } else if (globalArhetype.arhetip === 3) {
  ...
  } else if (globalArhetype.arhetip === 4) {
      ...
      <ImageBackground source={background} style={styles.image}>
        <ScrollView contentContainerStyle={styles.scrollViewContent}>
          <View style={styles.textContainer}>
            <Text style={styles.text}>Архетип: {globalArhetype.arhetip}</Text>
